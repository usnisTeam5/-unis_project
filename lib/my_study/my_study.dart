                  ...
                  child: Card(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(mystudy.roomName, style: TextStyle(color: Colors.grey[600],
                              fontFamily: 'Bold', fontSize: width * 0.05), overflow: TextOverflow.ellipsis,),
                          SizedBox(width: 10,),
                          SizedBox(height: 14),
                          Container(
                            width: width-35,
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  SizedBox(width: 4),
                                  Text(mystudy.startDate, style: TextStyle(fontFamily: 'Bold', fontSize: 13, color: Colors.grey[500]),),
                                ],
                              ),
                            ],
                          ),
