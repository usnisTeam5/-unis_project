...
class Solve extends StatefulWidget {
  ...
  final int quizKey; // 선택한 폴더 key
  List<QuizDto> candidates = []; // 후보군
  int curNum =0; // 퀴즈 개수
  String course = ''; // 과목명
  Solve({super.key, required this.quizKey, required this.curNum,required this.course, required this.candidates});
